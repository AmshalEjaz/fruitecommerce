            ...
            <div class="row">
                <div class="col-12 col-sm-8 col-md-6 m-auto">
                    <div class="card border-0 shadow"><br>
                        <h2 class="text-center display-6 text-primary">Login</h2><br>
                        <div class="card-body">
                            <form action="{{URL::to('/login')}}" method="POST">
                                @csrf
                                <input type="text" name="email" id="" class="form-control my-4 py-2" placeholder="Name/Mobile/Email" >
                                <input type="password" name="password" id="" class="form-control my-4 py-2" placeholder="Password" >
                                <div class="text-center">
                                    <button class="btn border border-secondary px-4 py-3 rounded-pill text-primary w-100" type="submit">Login</button>
                                    <p class="float-start" style="font-size: 12px;">forget password?<a href="forgetpassword.html">click here</a></p><br><br>
                                    <p class="text-center">Login as<a href="adminlogin.html"> Admin?</a></p>
                                    <p class="text-center">Don't have an account?<a href="{{URL::to('/showRegistrationForm')}}">Register</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
