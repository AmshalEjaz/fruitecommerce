        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="{{URL::to('about')}}">About Us</a>
                    <a class="btn-link" href="{{URL::to('contact')}}">Contact Us</a>
                    <a class="btn-link" href="{{URL::to('contact')}}">FAQs & Help</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="{{URL::to('shop')}}">Shop details</a>
                    <a class="btn-link" href="{{URL::to('cart')}}">Shopping Cart</a>
                    <a class="btn-link" href="{{URL::to('fproducts')}}">Featured Products</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
