...
@section('body')
    ...
    <div class="container-fluid page-header py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0">
            ...
            <li class="breadcrumb-item active text-white">2</li>
        </ol>
    </div>
                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-12">
                                    <div class="pagination d-flex justify-content-center mt-5">
                                        ...
                                        <a href="{{URL::to('shop')}}" class="rounded">1</a>
                                        <a href="2.html" class="active rounded">2</a>
                                        <a href="3.html" class="rounded">3</a>
